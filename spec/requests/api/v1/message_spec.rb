...
RSpec.describe 'Api::V1::Messages', type: :request do
  ...
  describe 'GET /user_msgs' do
    ...
    before do
      ...
      group = Group.find_by(preference_id: pref['id']).attributes
      chat = create(:chat, id_match: nil, id_group: group['id']).attributes
      message = create(:message, chat_id: chat['id'], user_id: user['id'], hora_de_envio: nil,
                                 conteudo: 'ola').attributes
  ...
  describe 'DELETE /user_msgs_delete' do
    ...
    before do
      ...
      group = Group.find_by(preference_id: pref['id']).attributes
      chat = create(:chat, id_match: nil, id_group: group['id']).attributes
      message = create(:message, chat_id: chat['id'], user_id: user1['id'], hora_de_envio: nil,
                                 conteudo: 'ola').attributes
